...
def test_nav2_data():
    ...
    g20 = nav0.sel(sv="G20")
    expected = [
        5.1321554929e-4, 6.821210263e-13, 0.0, 11, -74.125,
        4.944134514e-09, 0.736990015, -3.810971975327e-06,
        4.055858473293e-03, 1.130439341068e-5, 5.153679727554e3,
        14384, -2.980232238770e-8, -2.942741, -5.587935447693e-8,
        9.291603197140e-01, 144.8125, 2.063514928857,
        -8.198555788471e-09, 2.935836575092e-10,
        1, 2012, 0.0, 2.0, 0.0,
        -8.381903171539e-09, 11, 9456, 4,
    ]
...
def test_nav2_ionospheric_correction():
    ...
    assert nav.attrs["ionospheric_corr_GPS"] == approx(
        [0.4657e-08, 0.1490e-07, -0.5960e-07, -0.1192e-06,
         0.8192e05, 0.9830e05, -0.6554e05, -0.5243e06]
    )
